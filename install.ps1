...
.EXAMPLE
    ...
    iwr -useb https://raw.githubusercontent.com/jaiswal-naman/agentland/main/install.ps1 -OutFile install.ps1
    .\install.ps1 -Dev
...
# ── Config ────────────────────────────────────────────────────────────────────
$REPO_RAW_BASE = "https://raw.githubusercontent.com/jaiswal-naman/agentland/main"
