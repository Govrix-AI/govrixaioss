...
mod tests {
    ...
    fn encode_decode_roundtrip() {
        ...
        let info = govrix_ai_oss_common::license::validate_license(Some(&key));
        assert_eq!(info.tier, govrix_ai_oss_common::license::LicenseTier::Growth);
    ...
    fn community_key_falls_back_to_community_tier() {
        ...
        let info = govrix_ai_oss_common::license::validate_license(Some(&key));
        assert_eq!(info.tier, govrix_ai_oss_common::license::LicenseTier::Community);
    }
}
