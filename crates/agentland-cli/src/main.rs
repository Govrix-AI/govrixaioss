//! Agentland CLI — `agentland-ctl` command-line tool.
//!
//! Provides commands for interacting with a running Agentland proxy:
...
/// Agentland control plane CLI
#[derive(Debug, Parser)]
#[command(
    name = "agentland-ctl",
    version = env!("CARGO_PKG_VERSION"),
    about = "Agentland control plane CLI — interact with a running proxy",
    long_about = None,
)]
struct Cli {
