//! Bridge between the OSS [`PolicyHook`] trait and the Govrix [`PolicyEngine`].
//!
...
use govrix_ai_oss_proxy::policy::PolicyHook;

use crate::budget::{BudgetResult, BudgetTracker};
use crate::engine::{PolicyDecision, PolicyEngine};
use crate::pii;

/// Bridges the OSS `PolicyHook` trait to the Govrix `PolicyEngine`.
///
