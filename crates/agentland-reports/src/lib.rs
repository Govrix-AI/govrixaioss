//! Agentland Reports — HTML, JSON, and PDF report generation.
//!
...
impl Default for ReportContext {
    fn default() -> Self {
        Self {
            ...
            upsell_url: "https://Agentland.io".to_string(),
        }
    }
}
...
/// # Example
/// ```
/// use agentland_reports::{generate_all, usage::EventSummary};
...
/// # Example
/// ```
/// use agentland_reports::{ReportContext, render_template};
...
<body>
  ...
  <pre>{{ data }}</pre>
  <footer>
    Powered by Agentland OSS.
    <a href="{{ upsell_url }}">Upgrade to Agentland Enterprise</a>
...
mod tests {
    ...
    fn render_summary_template() {
        ...
        assert!(rendered.contains("Agentland.io"));
    }
