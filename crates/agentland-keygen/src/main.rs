...
#[derive(Parser)]
#[command(
    name = "agentland-keygen",
    about = "Generate Agentland Platform license keys"
)]
struct Cli {
    #[arg(
        long,
...
mod tests {
    ...
    fn encode_decode_roundtrip() {
        ...
        let info = agentland_common::license::validate_license(Some(&key));
        assert_eq!(info.tier, agentland_common::license::LicenseTier::Growth);
    ...
    fn community_key_falls_back_to_community_tier() {
        ...
        let info = agentland_common::license::validate_license(Some(&key));
        assert_eq!(info.tier, agentland_common::license::LicenseTier::Community);
    }
}
