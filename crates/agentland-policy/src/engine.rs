...
impl PolicyEngine {
    ...
    pub fn evaluate(&self, event: &agentland_common::models::AgentEvent) -> PolicyDecision {
    ...
    fn matches_all_conditions(
        &self,
        event: &agentland_common::models::AgentEvent,
    ...
    fn get_field_value(&self, event: &agentland_common::models::AgentEvent, field: &str) -> String {
        match field {
...
mod tests {
    ...
    fn make_event() -> agentland_common::models::AgentEvent {
        agentland_common::models::AgentEvent::new(
            "agent-001",
            Uuid::now_v7(),
