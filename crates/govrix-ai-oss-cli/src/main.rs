//! Govrix AI OSS CLI — `govrix-ai-oss-ctl` command-line tool.
//!
//! Provides commands for interacting with a running Govrix AI OSS proxy:
...
/// Govrix AI OSS control plane CLI
#[derive(Debug, Parser)]
#[command(
    name = "govrix-ai-oss-ctl",
    version = env!("CARGO_PKG_VERSION"),
    about = "Govrix AI OSS control plane CLI — interact with a running proxy",
    long_about = None,
)]
struct Cli {
    /// Govrix AI OSS API base URL
