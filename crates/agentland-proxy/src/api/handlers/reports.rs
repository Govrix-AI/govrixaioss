...
pub async fn list_reports() -> impl IntoResponse {
    ...
    Json(json!({
        "data": [],
        "total": 0,
        "note": "Report persistence is available in Agentland SaaS — see Agentland.io",
    }))
}
    ...
    (
        ...
        Json(json!({
            "data": {
                ...
                "note": "Full report generation with PDF export available in Agentland SaaS — see Agentland.io",
            }
        })),
    )
}
