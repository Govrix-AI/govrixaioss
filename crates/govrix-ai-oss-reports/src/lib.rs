//! Govrix AI OSS Reports — HTML, JSON, and PDF report generation.
//!
...
impl Default for ReportContext {
    fn default() -> Self {
        Self {
            ...
            upsell_url: "https://Govrix AI OSS.io".to_string(),
        }
    }
}
...
/// # Example
/// ```
/// use govrix_ai_oss_reports::{generate_all, usage::EventSummary};
...
/// # Example
/// ```
/// use govrix_ai_oss_reports::{ReportContext, render_template};
...
<body>
  ...
  <pre>{{ data }}</pre>
  <footer>
    Powered by Govrix AI OSS OSS.
    <a href="{{ upsell_url }}">Upgrade to Govrix AI OSS Enterprise</a>
...
mod tests {
    ...
    fn render_summary_template() {
        ...
        assert!(rendered.contains("Govrix AI OSS.io"));
    }
